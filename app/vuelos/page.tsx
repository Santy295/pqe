...
const routes = [
  {
    ...
    details: [
      ...
      { label: "Tipo", value: "Vuelo dinámico" },
      { label: "Incluye", value: "Fotos del vuelo" },
  ...
  },
  {
    ...
    details: [
      { label: "Duración", value: "30 – 40 min" },
...
const plans = [
  {
    ...
    includes: [
      "Vuelo biplaza coordinado",
      "Letras gigantes personalizadas en tierra",
      "Pétalos y decoración en la zona de aterrizaje",
  ...
  },
  {
    ...
    includes: [
      ...
      "Banner aéreo con mensaje dedicado",
